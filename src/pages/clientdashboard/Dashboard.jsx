    ...
    <div className="dashboard-container">
      ...
      <aside className="dash-sidebar">
        ...
        <nav className="dash-menu">
          ...
          <Link to="/Browsedonation" className="dash-menu-items">Browse Donations</Link>
          <Link to="/" className="dash-menu-items">My Requests</Link>
          <Link className="dash-menu-items">Active Pickups</Link>
          <Link className="dash-menu-items">Messages</Link>
          <Link className="dash-menu-items">Notifications</Link>
          <Link className="dash-menu-items">My Impact</Link>
          <Link className="dash-menu-items">Profile</Link>
        ...
        <button className="dash-logout-btn"><svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#666666"><path d="M200-120q-33 0-56.5-23.5T120-200v-560q0-33 23.5-56.5T200-840h280v80H200v560h280v80H200Zm440-160-55-58 102-102H360v-80h327L585-622l55-58 200 200-200 200Z"/></svg>
         Logout</button>
        </div>
      </aside>
